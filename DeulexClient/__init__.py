...
async def get_self():
    ...
    getself = await DeulexClient.get_me()
#     Adminsettings={}
    Owner = getself.id
    vr.set("SUDOS" , Owner)
...
DeulexClient = Client(Var.SESSION, api_id=Var.API_ID, api_hash=Var.API_HASH)
...
print ("Deulex Started Please Wait While The Plugins Load Automatically if any error occours send logs to @DeulexUserbot")